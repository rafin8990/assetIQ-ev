...
type MovementSummaryCard = {
  label: string
  value: string
}

type InventoryMovementReportPdfProps = {
  title: string
  subtitle: string
  generatedAt: string
  logoUrl: string
  ...
  rows: ReportTableRow[]
  summaryCards: MovementSummaryCard[]
}

type MainStockUpdateReportPdfProps = {
  title: string
  subtitle: string
  generatedAt: string
  logoUrl: string
...
export function InventoryMovementReportDocument({
  title,
  subtitle,
  generatedAt,
  logoUrl,
  ...
  rows,
  summaryCards,
}: InventoryMovementReportPdfProps) {
  return (
...
export function MainStockUpdateReportDocument({
  title,
  subtitle,
  generatedAt,
  logoUrl,
      ...
      <Page size="A4" style={styles.page} wrap>
        ...
        <View style={styles.summaryRow}>
          <View style={styles.summaryCard}>
            ...
            <Text style={styles.summaryValue}>{summary.entry_count}</Text>
          </View>
          <View style={styles.summaryCard}>
            <Text style={styles.summaryLabel}>Items</Text>
            <Text style={styles.summaryValue}>{summary.item_count ?? 0}</Text>
          </View>
          <View style={styles.summaryCard}>
            <Text style={styles.summaryLabel}>Total Quantity</Text>
            <Text style={styles.summaryValue}>
              {formatQuantity(summary.total_quantity)}
            </Text>
          </View>
        </View>
...
export function buildMovementSummaryCards(
